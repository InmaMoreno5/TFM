...
```{r}
fileNA<- ("C:/Users/Inma/Google Drive/Master Bioinformatica y bioestadistica/TFM/Datos VCF referencia/trio_chino/HG007_NA24695_mother.vcf.gz")
...
```{r}
genes.vcf<-tempfile()
writeVcf(vcf_chr, "genes_NA21631.vcf")
``` 
